  ...
  return (
    ...
    <div className="w-full p-4 text-center my-44 sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            <a href="https://web.facebook.com/SangkayHelpLine" className="transition-all w-full sm:w-auto bg-pink hover:bg-deeppink focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <a href="https://discord.gg/crggfDTptq" className="transition-all w-full sm:w-auto bg-pink hover:bg-deeppink focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center  px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
